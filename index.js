      ...
      if (answers.startQuestion === 'Viev All Employees') {
        ...
        inquirer
          ...
          .then((answers) => {
            ...
            addEmpQuery = `INSERT INTO employee (first_name, last_name, role_id, manager_id) VALUES ${answers.addEmployeeFirst}, ${answers.addEmployeeLast}, ${roleId}, ${empId}`
          })
        ...
        inquirer
          ...
          .then((answers) => {
            ...
            addRoleQuery = `INSERT INTO role (title, salary, department_id) VALUES ${answers.roleName}, ${answers.addSalary}, ${depId}}`
          })
        ...
        inquirer
          ...
          .then((answers) => {
            addDepQuery = `INSERT INTO department (name) VALUES ${answers.addDepName}`
          })
        ...
        inquirer
          ...
          .then((answers) => {
            ...
            addDepQuery = `UPDATE employee SET role_id = ${roleId} WHERE id = ${empId};`
            console.log("addDepQuery:", addDepQuery)
          })
